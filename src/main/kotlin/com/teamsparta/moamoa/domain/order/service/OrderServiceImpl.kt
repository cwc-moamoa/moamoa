...
class OrderServiceImpl(
    ...
    override fun createOrder(
        ...
        phoneNumber: String,
            ...
            val findProduct =
                productRepository.findByIdAndDeletedAtIsNull(productId).orElseThrow { ModelNotFoundException("Product", productId) }
            val stockCheck = productStockRepository.findByProduct(findProduct)

            if (stockCheck!!.stock <= quantity) throw IllegalArgumentException("재고가 모자랍니다. 판매자에게 문의해주세요")
    ...
    override fun updateOrder(
        ...
        updateOrderDto: UpdateOrderDto,
            ...
            val findUser = socialUserRepository.findByIdOrNull(userId) ?: throw ModelNotFoundException("User", userId)
            val findOrders = orderRepository.findByIdAndDeletedAtIsNull(orderId).orElseThrow { ModelNotFoundException("Order", orderId) }
            ...
            if (findOrders.socialUser == findUser) {
                ...
                throw IllegalArgumentException("도둑 검거 완료")
            }
    }
    ...
    override fun cancelOrder(
        ...
        orderId: Long,
            ...
            if (findUser.id != findOrder.socialUser.id) {
                throw ModelNotFoundException("Order", null)
            }
    ...
    override fun orderStatusChange(
        ...
        status: OrdersStatus,
            ...
            val findSeller = sellerRepository.findByIdAndDeletedAtIsNull(sellerId).orElseThrow { ModelNotFoundException("Seller", sellerId) }
    ...
    override fun getOrderBySellerId(
        ...
        val findSeller =
            sellerRepository.findByIdAndDeletedAtIsNull(sellerId).orElseThrow { ModelNotFoundException("Seller", sellerId) }
        val findOrder = orderRepository.findByIdOrNull(orderId) ?: throw ModelNotFoundException("Order", orderId)
